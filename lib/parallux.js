...
var Parallux = (_temp = _class = function () {
...
var ParalluxItem = (_temp2 = _class2 = function () {
  function ParalluxItem(node, viewPort) {
    ...
    var style = getAttribute(node, 'data-parallux-style');
  ...
  ParalluxItem.prototype.processMinValue = function processMinValue(value) {
  ...
  ParalluxItem.prototype.setWillChange = function setWillChange() {
    var styles = this.props.style ? Object.keys(this.props.style) : [];
  ...
  ParalluxItem.prototype.render = function render() {
    ...
    if (this.props.style) {
      Object.keys(this.props.style).forEach(function (key) {
        if (key === 'transform') {
          Object.keys(_this.props.style[key]).forEach(function (tans) {
            _this.transform += ' ' + tans + '(' + _this.getStyle(_this.props.style[key][tans]) + ')';
          });
        } else {
          _this.setStyle(key, _this.getStyle(_this.props.style[key]));
        }
      });
    }
